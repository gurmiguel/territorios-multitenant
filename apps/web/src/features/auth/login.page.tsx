...
export default function LoginPage() {
  ...
  const providers = search.get('providers')?.split(',')
  const hasProvider = (provider: string) => !providers || providers.includes(provider)
  ...
  return (
    <div className="absolute-fill flex flex-col items-center justify-center bg-black/50">
      ...
      <div className="relative flex flex-col bg-background p-4 shadow-xl rounded-lg w-3xs max-w-11/12">
        <h2 className="text-xl font-semibold mb-4 text-primary text-center">Acesse o aplicativo</h2>
