...
import { emailLogin, initGoogleSignIn } from './login.data'
    ...
    <div className="absolute-fill flex flex-col items-center justify-center bg-black/50">
      <div className="flex flex-col bg-background p-4 shadow-xl rounded-lg">
        ...
        <form action={emailLogin} className="flex flex-col justify-center gap-4">
          <Input type="email" name="email" label="E-mail" leftIcon={<MailIcon />} required />
        ...
        <Button onClick={() => initGoogleSignIn([window.location.origin, 'login/google-callback'].join('/'))} className="mx-auto bg-red-600 hover:bg-red-800/90 uppercase font-normal">
